...
let kIATBT_DEVICE_INFORMATION_SERVICE_UUID = CBUUID(string: "180A")
...
@objc public class IATBTDeviceInformationService : IATBTService {
    public convenience init() {
        self.init(serviceUUID: kIATBT_DEVICE_INFORMATION_SERVICE_UUID.uuidString,
                  required: true,
